...
or dial via Hyper Terminal (or such) using ATDTyour.bbs.com:port or dial ATDT3372234 to [Luiz Pacheco's](https://github.com/lgpf) micronet BBS ;)  
...
**First of all I would like to thank my friend [Luiz Pacheco](https://github.com/lgpf) for all the encouragement and feedback (also for electronic schematics).**  
